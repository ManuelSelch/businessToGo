...
public struct KimaiTimesheetsListView: View {
    ...
    public init(projects: [KimaiProject], timesheets: [KimaiTimesheet], timesheetChanges: [DatabaseChange], activities: [KimaiActivity], deleteTapped: @escaping (KimaiTimesheet) -> Void, editTapped: @escaping (KimaiTimesheet) -> Void) {
